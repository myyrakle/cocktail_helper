  ...
  return await openDatabase(
    ...
    onCreate: (db, version) async {
      ...
      await db.execute(
        ...
        ('LIQUEUR', 'PARFAIT', '파르페 아모르', '오렌지와 바닐라 등이 첨가된 보라색 리큐르입니다.', 160),
        ('LIQUEUR', 'CAMPARI', '캄파리', '캄파리는 이탈리아의 약주입니다. 씁쓸하고 독특한 맛을 내죠.', 160),
        ('LIQUEUR', 'VERMOUTH_SWEET', '스위트 베르무트', '베르무트는 이탈리아의 주정강화 와인으로, 독특한 향을 냅니다.', 160),
        ('LIQUEUR', 'VERMOUTH_DRY', '드라이 베르무트', '베르무트는 이탈리아의 주정강화 와인으로, 독특한 향을 냅니다.', 160),
        ('LIQUEUR', 'DRAMBUIE', '드럼부이', '드럼부이는 스카치 위스키에 꿀 등을 첨가한 고급 리큐르입니다.', 160),
        ('LIQUEUR', 'GRAND_MARNIER', '그랑 마르니에', '그랑 마르니에는 코냑을 기반으로 만든 오렌지맛 리큐르입니다.', 160),
        ('LIQUEUR', 'BENEDICTINE', '베네딕틴', '베네딕틴은 브랜디를 기반으로 만든 독특한 프랑스 리큐르입니다.', 160),
        ('LIQUEUR', 'GALLIANO', '갈리아노', '갈리아노는 아니스, 생각, 시트러스, 바닐라 등의 다양한 재료로 만든 이탈리아 약주입니다. 약간 누런 색이 특징입니다.', 160),
        ('LIQUEUR', 'SLOE_GIN', '슬로 진', '슬로 진은 진에 슬로베리라는 자두 종류를 넣어 만든 리큐르입니다. 새콤달콤한 맛이 특징입니다.', 160),
        ('LIQUEUR', 'SOUTHERN COMFORT', '서던 컴포트', '서던 컴포트는 버번 위스키에 다양한 재료를 첨가해 만든 리큐르입니다. 달콤하고 향긋하다네요.', 160),
        ('LIQUEUR', 'SHARTREUSE_GREEN', '샤르트뢰즈 그린', '샤르트뢰즈는 가장 비밀스럽고 존재감이 큰 리큐르 중 하나입니다. 131개의 재료가 들어가고, 한때는 엘릭서로 취급하기도 했다네요.', 160),
        ('LIQUEUR', 'ABSINTHE', '압생트', '압생트는 강렬한 향의 녹색 술입니다. 환각제 논란도 있었고, 짝퉁도 많고, 참 다사다난한 술이죠.', 160),
        ('LIQUEUR', 'JAGERMEISTER', '예거마이스터', '예거마이스터는 독일의 약주입니다. 걸쭉한 단맛에, 특유의 독특한 향이 특징입니다.', 160),
        ('LIQUEUR', 'AGWA', '아그와', '아그와는 네덜란드의 옅은 녹색의 허브 리큐르입니다. 코카잎, 녹차, 라벤더, 오이 등이 들어간다고 하네요.', 160),
        ('LIQUEUR', 'X_RATED', '엑스레이티드', '엑스레이티드는 분홍빛의 달콤한 리큐르입니다.', 160),
        ('LIQUEUR', 'ALIZE_BLUE', '엘리제 블루', '엘리제는 코냑과 보드카를 기반으로 만든 리큐르입니다. 블루는 패션프루츠, 체리, 생강 등이 첨가됐어요.', 160),
        ('LIQUEUR', 'ALIZE_ROSE', '엘리제 로즈', '엘리제는 코냑과 보드카를 기반으로 만든 리큐르입니다. 로즈는 패션프루츠, 딸기 등이 첨가됐어요.', 160),
        ('LIQUEUR', 'KWAI_FEH', '콰이페', '콰이페는 리치라는 열매로 만든 달콤한 리큐르입니다.', 160),
        ('LIQUEUR', 'FIRE_BALL', '파이어볼', '파이어볼은 버번 위스키에 계피 등을 첨가한 독특한 리큐르입니다.', 160),
        ('LIQUEUR', 'LIMONCELLO', '리몬첼로', '리몬첼로는 이탈리아의 새콤달콤한 레몬맛 리큐르입니다.', 160),
        ('LIQUEUR', 'FRANGELICO', '프랑젤리코', '프랑젤리코는 이탈리아의 헤이즐넛 리큐르입니다.', 160),
        ('LIQUEUR', 'ANGOSTURA_BITTERS', '앙고스투라 비터스', '앙고스투라 비터스는 아로마향과 쓴맛이 특징인 칵테일용 조미료입니다. 일부 칵테일에 몇 방울씩만 넣어 맛을 돋우는 역할을 합니다.', 160),
        ...
        ('SYRUP', 'SYRUP', '시럽', '시럽은 그냥 설탕물입니다.\n구매해서 사용해도 좋지만, 그냥 물과 설탕을 부피 1:1로 섞어서 끓이면 쉽게 만들어집니다. 이것저것 첨가해도 좋고요.', 10),
        ...
        ('SYRUP', 'HONEY', '꿀', '꿀꿀', 100),  
        ('SYRUP', 'ORANGE_FLOWER_WATER', '오렌지 플라워 워터', '오렌지 플라워 워터는 비터오렌지라는 나무의 꽃을 증류해 만든 독특한 향유입니다. 칵테일에는 주로 라모스 진피즈에 사용합니다.', 100),  
        
        ('JUICE', 'LEMON_JUICE', '레몬주스', '레몬주스는 레몬을 직접 짜서 사용해도 좋지만, 별도로 파는 레몬주스 제품이 사용이 용이합니다. Lazy가 저렴하고 흔해서 무난합니다.', 50),
        ('JUICE', 'LIME_JUICE', '라임주스', '라임주스는 라임을 직접 짜서 사용해도 좋지만, 별도로 파는 라임주스 제품이 사용이 용이합니다. 지룩스를 추천합니다.', 50),
        ('JUICE', 'ORANGE_JUICE', '오렌지주스', '오렌지로 만든 주스죠.', 50),
        ('JUICE', 'CRANBERRY_JUICE', '크렌베리주스', '크렌베리로 만든 주스입니다. 새콤하고 살짝 떫은 맛이 특징이죠.', 50),
        ('JUICE', 'GRAPEFRUIT_JUICE', '자몽주스', '자몽 주스!', 50),
        ('JUICE', 'PINEAPPLE_JUICE', '파인애플주스', '파인애플 주스!', 50),
        ('JUICE', 'APPLE_JUICE', '사과주스', '사과 주스!!!', 50),
        ('JUICE', 'TOMATO_JUICE', '토마토주스', '토마토 주스!!!!', 50),
        ...
        ('OTHERS', 'EGG_WHITE', '계란 흰자', '대부분의 레시피는 흰자만을 쓰는 편입니다.\n흰자만 잘 골라내서 쓰고, 노른자는 비빔밥에 쓰면 됩니다.', 140), 
        ...
        ('OTHERS', 'CACAO_POWDER', '카카오 파우더', 180)
        ''');
